...
function Navbar({isLogin}){
  return(
    <div className='0 fixed top-0 left-0 flex flex-row justify-between w-screen item-center bg-gradient-to-b from-gray-900 to-transparent'>
...
function Right(){
  return(
    <div className='w-full tracking-wider  pt-2 pr-2 text-sm flex flex-row space-x-1 justify-end items-center'>
      ...
      <div className='w-2/3 bg-gradient-to-br rounded from-yellow-500 py-3 px-1 to-yellow-600 text-center font-sans font-medium brightness-110'><h5>Sign Up Now</h5></div>
    </div>
  );
}
